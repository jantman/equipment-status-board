...
class TestListAreas:
    ...
    def test_returns_active_areas_ordered(self, app):
        ...
        _create_area('Electronics Lab', '#electronics')
    ...
    def test_excludes_archived_areas(self, app):
        """list_areas() excludes archived areas."""
        from esb.services.equipment_service import list_areas

        _create_area('Active Area', '#active')
        archived = _create_area('Archived Area', '#archived')
...
class TestGetArea:
    ...
    def test_returns_area_by_id(self, app):
...
class TestUpdateArea:
    ...
    def test_updates_area_successfully(self, app):
    ...
    def test_update_persists_to_db(self, app):
    ...
    def test_name_conflict_raises(self, app):
    ...
    def test_same_name_allowed(self, app):
        """update_area() allows keeping the same name."""
        from esb.services.equipment_service import update_area

        area = _create_area('Keep Name', '#channel')
    ...
    def test_logs_area_updated_mutation(self, app, capture):
    ...
    def test_logs_empty_changes_when_no_diff(self, app, capture):
        """update_area() logs empty changes when nothing changed."""
        from esb.services.equipment_service import update_area

        area = _create_area('Same', '#same')
...
class TestArchiveArea:
    ...
    def test_archives_area_successfully(self, app):
    ...
    def test_archive_persists_to_db(self, app):
    ...
    def test_already_archived_raises(self, app):
    ...
    def test_logs_area_archived_mutation(self, app, capture):
